...
E.g.
    ...
    proxy = Peachy::Proxy.new('<xml version="1.0.0"><node>Peachy</node></xml>')
    puts "Element contents: " + proxy.xml.node.value
    => Element contents: Peachy
    puts "Element attribute: " + proxy.xml.version
